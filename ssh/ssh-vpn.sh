...
wget -O portsshnontls "https://raw.githubusercontent.com/miftachuda/Autovps/master/websocket/portsshnontls.sh"
wget -O portsshws "https://raw.githubusercontent.com/miftachuda/Autovps/master/websocket/portsshws.sh"
